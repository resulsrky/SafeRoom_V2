...
public class JoinMeetController {
    ...
    private void populateCameraDevices() {
        try {
            ...
            if (cameras.isEmpty()) {
                ...
                System.out.println("[JoinMeet] No cameras available");
                return;
            }
            ...
            System.out.printf("[JoinMeet] Found %d camera(s)%n", cameras.size());
        } catch (Exception e) {
            System.err.println("[JoinMeet] Error enumerating cameras: " + e.getMessage());
    ...
    private void populateAudioInputDevices() {
        ...
        new Thread(() -> {
            try {
                java.util.List<dev.onvoid.webrtc.media.audio.AudioDevice> microphones = 
                ...
                javafx.application.Platform.runLater(() -> {
                    ...
                    if (microphones.isEmpty()) {
                        ...
                        System.out.println("[JoinMeet] No microphones available");
                        return;
                    }
                    ...
                    System.out.printf("[JoinMeet] Found %d microphone(s)%n", microphones.size());
                });
            } catch (Exception e) {
                System.err.println("[JoinMeet] Error enumerating microphones: " + e.getMessage());
                javafx.application.Platform.runLater(() -> {
                    audioInputBox.getItems().clear();
    ...
    private void populateAudioOutputDevices() {
        ...
        new Thread(() -> {
            try {
                java.util.List<dev.onvoid.webrtc.media.audio.AudioDevice> speakers = 
                ...
                javafx.application.Platform.runLater(() -> {
                    ...
                    if (speakers.isEmpty()) {
                        ...
                        System.out.println("[JoinMeet] No speakers available");
                        return;
                    }
                    ...
                    System.out.printf("[JoinMeet] Found %d speaker(s)%n", speakers.size());
                });
            } catch (Exception e) {
                System.err.println("[JoinMeet] Error enumerating speakers: " + e.getMessage());
                javafx.application.Platform.runLater(() -> {
                    audioOutputBox.getItems().clear();
    ...
    private void handleCameraSelection() {
        ...
        try {
            ...
            if (selectedIndex < cameras.size()) {
                ...
                System.out.println("[JoinMeet] Camera selected: " + selectedCamera.getName());
            ...
            System.err.println("[JoinMeet] Error changing camera: " + e.getMessage());
        }
    }
    ...
    private void handleMicrophoneSelection() {
        ...
        try {
            ...
            if (selectedIndex < microphones.size()) {
                ...
                System.out.println("[JoinMeet] Microphone selected: " + selectedMicrophone.getName());
                // Microphone will be applied when joining the meeting
            }
        } catch (Exception e) {
            System.err.println("[JoinMeet] Error changing microphone: " + e.getMessage());
        }
    }
    ...
    private void handleSpeakerSelection() {
        ...
        try {
            ...
            if (selectedIndex < speakers.size()) {
                ...
                System.out.println("[JoinMeet] Speaker selected: " + selectedSpeaker.getName());
                // Speaker will be applied when joining the meeting
            }
        } catch (Exception e) {
            System.err.println("[JoinMeet] Error changing speaker: " + e.getMessage());
        }
    }
